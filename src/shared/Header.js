            ...
            <React.Fragment>
                <Grid z_index= "1" position="fixed" BG_c="#F2F2F2" height="70px" width="100%">
                    <Grid is_between padding="0px 15px 0px 0px">
                        <Grid>
                            <Image shape="imagePost" src={wikiwiki_logo} _onClick={()=>{window.location.href = '/'}}/>
                        </Grid>
        ...
        <React.Fragment>
            <Grid z_index= "1" position="fixed" BG_c="#F2F2F2" height="70px" width="100%">
                <Grid is_between padding="0px 15px 0px 0px">
                    ...
                    <Grid>
                        <Button _onClick={()=>{window.location.href = '/'}} BG_color="white" font_weight="bold" font_size="15x" font_color="#E65923" height="45px" Border="2px solid #E65923" B_radius="5px">
                            홈으로</Button>
                    </Grid>
                </Grid>
            </Grid>
